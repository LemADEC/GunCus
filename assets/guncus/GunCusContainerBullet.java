...
public class GunCusContainerBullet extends Container {
	...
	public void create() {
		...
		if ((mag != null)
				...
				&& ( (right == null)
				  || ((right != null) && (right.getItem() != null) && (right.getItem().itemID == bullet.itemID) && (right.stackSize + bullet.stackOnCreate <= 64)))
	...
	public String[] info() {
		...
		if (gun != null) {
			...
			if ((iron >= 0) && (sulphur >= 0) && ((iron > 0) || (sulphur > 0))) {
				rtn = "Gun = \"" + gun.gunName + "\", Bullets = \"" + bullet.name + "\", Pack = \"" + gun.pack + "\"";
