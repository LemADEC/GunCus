...
/*    */ 
/*    */ public class GunCusGuiAmmoMan extends GuiContainer
/*    */ {
/*    */   public GunCusGuiAmmoMan(InventoryPlayer inventory, World world, int x, int y, int z)
/*    */   {
/* 25 */     super(new GunCusContainerAmmoMan(inventory, world, x, y, z));
/*    */   }
/*    */ 
/*    */   protected void drawGuiContainerForegroundLayer(int par1, int par2)
/*    */   {
/* 30 */     this.fontRenderer.drawString("Manual Mag Filler", 8, this.ySize - 160, 4210752);
...
/* 35 */     this.buttonList.add(new GuiButton(0, var5 + 10, var6 + 40, 40, 20, "Fill Up"));
/* 36 */     this.buttonList.add(new GuiButton(1, var5 + 125, var6 + 40, 40, 20, "Empty"));
/*    */   }
/*    */ 
/*    */   protected void drawGuiContainerBackgroundLayer(float f, int x, int y)
/*    */   {
/* 41 */     GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
/* 42 */     this.mc.getTextureManager().bindTexture(new ResourceLocation("guncus:textures/gui/gui_ammo.png"));
 ...
 * Qualified Name:     assets.guncus.GunCusGuiAmmoMan
