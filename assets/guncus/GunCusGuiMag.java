...
/*    */ 
/*    */ public class GunCusGuiMag extends GuiContainer
/*    */ {
/*    */   public GunCusGuiMag(InventoryPlayer inventory, World world, int x, int y, int z)
/*    */   {
/* 25 */     super(new GunCusContainerMag(inventory, world, x, y, z));
/*    */   }
/*    */ 
/*    */   protected void drawGuiContainerForegroundLayer(int par1, int par2)
/*    */   {
/* 30 */     this.fontRenderer.drawString("Mag Box", 8, this.ySize - 160, 4210752);
...
/* 42 */     this.mc.getTextureManager().bindTexture(new ResourceLocation("guncus:textures/gui/gui_mag.png"));
 ...
 * Qualified Name:     assets.guncus.GunCusGuiMag
