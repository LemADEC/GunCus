...
GameRegistry.registerBlock(mineBlock);
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.addRecipe(new ItemStack(rpg, 1), new Object[] { "IIR",
				"IWR", "RRW", Character.valueOf('I'),
				new ItemStack(Item.ingotIron), Character.valueOf('W'),
				new ItemStack(Block.planks), Character.valueOf('R'),
				new ItemStack(Item.redstone) });
		GameRegistry.addRecipe(new ItemStack(smaw, 1), new Object[] { "RI ",
				"IRI", " IR", Character.valueOf('I'),
				new ItemStack(Item.ingotIron), Character.valueOf('R'),
				new ItemStack(Item.redstone) });

		GameRegistry.addRecipe(new ItemStack(rpgm, 2), new Object[] { "II ",
				"IG ", "  G", Character.valueOf('I'),
				new ItemStack(Item.ingotIron), Character.valueOf('G'),
				new ItemStack(Item.gunpowder) });
		GameRegistry.addRecipe(new ItemStack(smawm, 2), new Object[] { "G  ",
				" GI", " II", Character.valueOf('I'),
				new ItemStack(Item.ingotIron), Character.valueOf('G'),
				new ItemStack(Item.gunpowder) });
	}
}
