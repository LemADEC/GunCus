...
public class BlockBullet extends GunCusBlock {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		this.field_94385_a = par1IconRegister.registerIcon("guncus:bullet");
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
		...
		par5EntityPlayer.openGui(GunCus.instance, GuiHandler.bulletBlock, par1World, par2, par3, par4);
		return true;
	}
}
