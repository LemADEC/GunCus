...
public class BlockAmmo extends GunCusBlock {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		iconTop = par1IconRegister.registerIcon("guncus:ammo");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityPlayer,
		...
		entityPlayer.openGui(GunCus.instance, GuiHandler.ammoBlock, world, x, y, z);
		return true;
	}
}
