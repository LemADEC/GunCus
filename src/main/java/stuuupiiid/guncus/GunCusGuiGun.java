...
public class GunCusGuiGun extends GuiContainer {
	public GunCusGuiGun(InventoryPlayer inventory, World world, int x, int y, int z) {
		super(new GunCusContainerGun(inventory, world, x, y, z));
	}

	@Override
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRendererObj.drawString("Gun Box", 8, this.ySize - 160, 0x404040);
		...
		this.buttonList.add(new GuiButton(0, var5 + 10, var6 + 40, 40, 20, "Split"));
		this.buttonList.add(new GuiButton(1, var5 + 125, var6 + 40, 40, 20, "Build"));
	}
