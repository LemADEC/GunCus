...
public class PacketHandler {
	...
	public static void init() {
		...
		simpleNetworkManager.registerMessage(MessageBulletImpact.class , MessageBulletImpact.class , 10, Side.CLIENT);	// legacy 10
	...
	public static void sendToClient_bulletImpact(EntityPlayer entityPlayer) {
		MessageBulletImpact bulletSoundMessage = new MessageBulletImpact();
