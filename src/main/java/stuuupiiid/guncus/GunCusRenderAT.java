...
public class GunCusRenderAT extends RenderArrow {
	public void renderArrow(GunCusEntityAT par1EntityArrow, double par2, double par4, double par6, float par8,
			float par9) {
		GL11.glPushMatrix();
	...
	protected ResourceLocation getEntityTexture(Entity par1Entity) {
		return new ResourceLocation("guncus:textures/entity/at.png");
	}

	@Override
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		if (((GunCusEntityAT) par1Entity).ticks >= 2) {
			renderArrow((GunCusEntityAT) par1Entity, par2, par4, par6, par8, par9);
		}
	}
}
