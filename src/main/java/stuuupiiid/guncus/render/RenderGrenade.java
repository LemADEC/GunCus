...
public class RenderGrenade extends RenderArrow {
	public void renderArrow(EntityGrenade par1EntityArrow, double par2, double par4, double par6, float par8,
			float par9) {
		GL11.glPushMatrix();
	...
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		if (((EntityGrenade) par1Entity).ticks >= 2) {
			renderArrow((EntityGrenade) par1Entity, par2, par4, par6, par8, par9);
		}
	}
}
